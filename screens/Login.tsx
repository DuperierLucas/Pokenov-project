  ...
  return (
    <View style={styles.container}>
        <View style={styles.withEmailContainer}>
            ...
            <TextInput secureTextEntry={true} textContentType={'password'} placeholder={'mot de passe'} autoCapitalize={'none'} onChangeText={(val) => setPassword(val)}/>
            <Button onPress={() => connectWithEmail(email, password)} title={'Connexion'}/>
        </View>
